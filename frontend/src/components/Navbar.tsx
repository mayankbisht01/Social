    ...
    return (
        ...
        <div className="backdrop-blur-2xl max-w-2xl mx-auto sticky top-8 bg-white/60 flex border-black p-3 items-center justify-between px-8 shadow-lg rounded-full">
            ...
            <div className="flex flex-row gap-6">
                <button
                    onClick={() => navigate("/")}
                    className="cursor-pointer px-2 py-2 border rounded-full shadow-lg">
                ...
                <button
                    ...
                    className="cursor-pointer shadow-lg border px-2 py-2 rounded-full">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-4">
                ...
                <button
                    ...
                    className="cursor-pointer px-2 py-2 rounded-full shadow-lg border">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-4">
